...
4. Document the frozen model revision, head checkpoint, calibration temperature, threshold, experiment fingerprint, and `<2B` compliance. Explain that CLIP downloads on first setup and is not committed.
